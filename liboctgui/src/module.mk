...
DIRSTAMP_FILES += %reldir%/m-editor/$(octave_dirstamp)
...
$(OCTAVE_GUI_SRC_MOC): | %reldir%/$(octave_dirstamp)

## Rule to build directory stamp  
DIRSTAMP_FILES += %reldir%/$(octave_dirstamp)

## All MOC source files
octave_gui_MOC += $(OCTAVE_GUI_SRC_MOC)
...
## UI file
octave_gui_UI = %reldir%/settings-dialog.ui
...
noinst_LTLIBRARIES += %reldir%/libsrc.la

%canon_reldir%_libsrc_la_SOURCES = \
...
nodist_%canon_reldir%_libsrc_la_SOURCES := \
  $(octave_gui_MOC) \
  $(octave_gui_RC)

%canon_reldir%_libsrc_la_CPPFLAGS := \
  $(AM_CPPFLAGS) \
  @OCTGUI_DLL_DEFS@ \
  -I%reldir% -I$(srcdir)/%reldir% \
  -I$(srcdir)/%reldir%/m-editor \
  -I$(srcdir)/liboctgui/graphics \
  -I$(srcdir)/liboctgui/qterminal/libqterminal \
...
liboctgui_liboctgui_la_LIBADD += %reldir%/libsrc.la
