...
## window length of 3, @code{movmad} uses data elements @w{@code{[4, 5, 6]}}.
## @item
...
## @code{movmad} uses data elements @w{@code{[3, 4, 5, 6, 7]}}.
## @item
...
## @code{movmad} uses data elements @w{@code{[4, 5, 6, 7]}}.
## @end itemize
##
