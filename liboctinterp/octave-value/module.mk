...
## FIXME: JAVA_LIBS variable is empty (instead of -ljvm).
## Maybe we misunterstand how C++/Java API compilation is done?
%canon_reldir%_liboctave_value_la_LIBADD = $(JAVA_LIBS)

liboctinterp_liboctinterp_la_LIBADD += %reldir%/liboctave-value.la
