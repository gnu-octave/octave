...
################################################################################
## Usage: mk-pkg-add.sh SRCDIR file1.cpp [file2.cpp]...
## Purpose: Construct PKG_ADD file from C++ DLDFCN source files.
################################################################################

set -e

if [ $# -lt 2 ]; then
  echo "usage: mk-pkg-add.sh SRCDIR file1.cpp [file2.cpp]..." 1>&2
  exit 1
fi
