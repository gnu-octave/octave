...
libgraphics_MOC = $(OCTAVE_GUI_GRAPHICS_MOC)

libgraphics_MOC_H := $(libgraphics_MOC:.cc=.h)

libgraphics_UI = %reldir%/annotation-dialog.ui
...
%canon_reldir%_libgraphics_la_CPPFLAGS := \
  ...
  -Iliboctgui/src -I$(srcdir)/liboctgui/src \
...
liboctgui_liboctgui_la_LIBADD += %reldir%/libgraphics.la
