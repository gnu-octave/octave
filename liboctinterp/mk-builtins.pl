...
if ($make_header)
{
  ...
  while ($file = shift (@ARGV))
  {
    ...
    while (<$FH>)
    {
      ## Generate a list of function names to declare.  We could do this in
      ## one step, but this way keeps the regexp patterns a bit smaller.
