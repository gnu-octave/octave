BUILT_LIBOCTINTERP_OPERATORS_SRC = \
  %reldir%/ops.cc
...
%reldir%/ops.cc: $(LIBOCTINTERP_OPERATORS_SRC) %reldir%/mk-ops.sh | %reldir%/$(octave_dirstamp)
	$(AM_V_GEN)rm -f $@-t $@ && \
	$(SHELL) $(srcdir)/%reldir%/mk-ops.sh $(LIBOCTINTERP_OPERATORS_SRC) > $@-t && \
	mv $@-t $@
