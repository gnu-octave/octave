...
## window length of 3, @code{movprod} uses data elements @w{@code{[4, 5, 6]}}.
## @item
...
## @code{movprod} uses data elements @w{@code{[3, 4, 5, 6, 7]}}.
## @item
...
## @code{movprod} uses data elements @w{@code{[4, 5, 6, 7]}}.
## @end itemize
##
