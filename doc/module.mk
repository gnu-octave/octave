...
## FIXME: These definitions are probably redundant with what Automake would do.
DVIPS = dvips
TEX = tex
PDFTEX = pdftex

## Define Automake expressions that produce pretty build output to console.
...
## Conditionally define the following variables so that --disable-docs can
## work.  If we don't define them, Automake will always define them, even when
## AMCOND_BUILD_DOCS is false.
...
## Listing "dvi" explicitly here seems to cause two simultaneous builds of the
## DVI files, presumably because the PS version also depends on the DVI file
## and somehow the rules are invoked twice.  Is that a bug in automake or make
## or what?
