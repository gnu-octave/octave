...
##
## The following degree-based centrality measures are available:
##
## @table @code
## @item "degree"
...
##
## Parallel edges in a multigraph are each counted individually so the
## centrality reflects the true edge count, not the number of distinct
## neighbours.  Edge weights are ignored; the @code{"Cost"} and
## @code{"Importance"} name-value options that MATLAB supports for
## weighted centralities are not yet implemented.
##
## @example
## @group
...
## @end example
##
## @seealso{graph, digraph, degree, indegree, outdegree}
## @end deftypefn
...
## These should error until US-CT02+ add them.

%!error <unknown|invalid|unrecognized|not yet|not implemented>
%! centrality (graph ([1 2], [2 3]), "closeness");
